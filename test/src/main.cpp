...
// glfwWindowHint(GLFW_OPENGL_FORWARD_COMPAT, GL_TRUE);            // 3.0+ only
    ...
    GLFWwindow *window = glfwCreateWindow(1280, 720, "RBD3D TEST", NULL, NULL);
    if (window == NULL)
        return 1;
    ...
    { // Setup Dear ImGui context
        ...
        TestManager::registTest<TestJoint>("Joint");
        ...
        while (!glfwWindowShouldClose(window))
        {
            ...
            TestManager::onUpdate(io.DeltaTime);
            int viewportWidth, viewportHeight;
            glfwGetWindowSize(window, &viewportWidth, &viewportHeight);
            TestManager::onRender(viewportWidth, viewportHeight);
